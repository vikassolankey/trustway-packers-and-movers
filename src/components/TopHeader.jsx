    ...
    <div className="bg-black text-white text-xs md:text-sm border-b border-white/10 w-full">
      <div className="max-w-7xl mx-auto px-6 py-2 flex flex-col sm:flex-row items-center justify-between gap-2">
        <div className="hidden md:flex flex-wrap items-center gap-x-4 gap-y-1">
          <span className="text-white/90">UDYAM-UP-25-0019826</span>
          <span className="hidden sm:inline text-white/30">|</span>
          <span className="text-white/90">GSTIN:09EMMPB2450Q1ZL</span>
          <span className="hidden sm:inline text-white/30">|</span>
            <span className="text-white/90">ISO No.9001:2015</span>
        </div>
        <div className="flex items-center gap-4 sm:gap-6">
          <a href="mailto:v.ssolankig@gmail.com" className="flex items-center gap-2 hover:text-amber-400 transition-colors">
            ...
            <span className="text-white/90">Info@trustwaypackersandmovers.co.in</span>
          </a>
          <a href="tel:+919258157772" className="hidden sm:flex items-center gap-2 hover:text-amber-400 transition-colors">
